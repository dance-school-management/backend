import { GetInstructorExperienceRequest, GetInstructorExperienceResponse } from "../../../../proto/ProfileToEnrollMessages_pb";
...
export async function getInstructorExperience(
  ...
  return new Promise((resolve, reject) => {
      const request = new GetInstructorExperienceRequest().setInstructorId(
        instructorId,
      );
      profileToEnrollClient.getInstructorExperience(
        request,
        (err, response) => {
          console.log(err);
          if (err) {
